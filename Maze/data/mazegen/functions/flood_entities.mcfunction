...
execute as @e[tag=maze_flood_active] if score @s maze_x < @e[tag=maze_se,limit=1] maze_x at @s positioned ~2 ~ ~ unless entity @e[tag=maze_marker,distance=0...1] run summon minecraft:marker ~ ~ ~ {Tags:["maze_flood_new","maze_marker"]}
execute as @e[tag=maze_flood_active] if score @s maze_z < @e[tag=maze_se,limit=1] maze_z at @s positioned ~ ~ ~2 unless entity @e[tag=maze_marker,distance=0...1] run summon minecraft:marker ~ ~ ~ {Tags:["maze_flood_new","maze_marker"]}
