...
execute if entity @e[tag=maze_stack_next] as @e[tag=maze_stack_active] at @s run setblock ~ ~ ~ orange_concrete
execute if entity @e[tag=maze_stack_next] as @e[tag=maze_stack_active] at @s anchored feet facing entity @e[tag=maze_stack_next,limit=1] feet run setblock ^ ^ ^1 orange_concrete
...
execute unless entity @e[tag=maze_stack_next] as @e[tag=maze_stack_active] at @s run setblock ~ ~ ~ light_blue_concrete
...
execute if entity @e[tag=maze_stack_last] as @e[tag=maze_stack_active] at @s anchored feet facing entity @e[tag=maze_stack_last,limit=1] feet run setblock ^ ^ ^1 light_blue_concrete
