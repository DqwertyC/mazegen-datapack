...
execute if entity @e[tag=maze_next] as @e[tag=active_marker] at @s run setblock ~ ~ ~ orange_concrete
execute if entity @e[tag=maze_next] as @e[tag=active_marker] at @s anchored feet facing entity @e[tag=maze_next,limit=1] feet run setblock ^ ^ ^1 orange_concrete
...
execute unless entity @e[tag=maze_next] as @e[tag=active_marker] at @s run setblock ~ ~ ~ light_blue_concrete
...
execute unless entity @e[tag=maze_next] if entity @e[tag=last_marker] as @e[tag=active_marker] at @s anchored feet facing entity @e[tag=last_marker,limit=1] feet run setblock ^ ^ ^1 light_blue_concrete
